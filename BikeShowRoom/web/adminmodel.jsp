...
<%
		...
		String t2=request.getParameter("text2");
                ...
                if(t1!=null&&t1!=""){
		stmt.executeUpdate("insert into ModelTab value('" + t1 + "','" + t2 + "')");
...
<tr><td height ="100" width="25%"></td><td>
    ...
    <form method="POST"    action="adminmodel.jsp">
    <table border="0"> 
    <tr> <td height="20" colspan="2"> <img style="-webkit-user-select: none" src="images/model.bmp"> </td> </tr>    
    <tr> <td height="60" colspan="2"> </td> </tr> 
    <tr> <td height="40"> Model Name </td> <td> <input type="text" name="text1" value=""></td> </tr>
